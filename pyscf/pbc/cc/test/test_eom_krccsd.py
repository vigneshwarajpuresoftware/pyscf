...
# Running HF and CCSD with 1x1x2 Monkhorst-Pack k-point mesh
        ...
        imds = eom.make_imds(eris)
        hc = eom.matvec(vector, 0, imds)
        self.assertAlmostEqual(lib.finger(hc), (-2.6242967982318532-0.19622574939883755j), 8)
        hc = eom.matvec(vector, 1, imds)
...
# Running HF and CCSD with 1x1x2 Monkhorst-Pack k-point mesh
        ...
        hc = eom.l_matvec(vector, 2, imds)
        self.assertAlmostEqual(lib.finger(hc), (-1.9053243731138183+2.785112360342188j), 7)
